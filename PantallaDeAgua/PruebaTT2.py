...
def realizar_acciones(text):
    ...
    if len(parts) >= 2:
        ...
        if Peticion == 'muestrame' or Peticion == 'enseñame' or Peticion =='Muéstrame' or Peticion =='Dime' or Peticion =='dime':
            ...
            # Si después de todas las comprobaciones aún queda texto, indicar que es una acción desconocida
                print("Lo siento, no puedo entender esa instrucción.")
    else:
...
class MainWindow(tk.Frame):
    ...
    # Crear los labels y colocarlos usando pack
        ...
        self.deletro = tk.Label(self.master, text='Puedes obtener el deletreo de cualquier palabra diciendo simplemente "Deletrea", seguido de la palabra que quieras.', bg='#d0d0d0')
        ...
        self.aritmetica = tk.Label(self.master, text='Puedes solicitar operaciones de suma o resta con números del 0 al 9. Simplemente indica "Suma" o "Resta", seguido de 2 números que prefieras.', bg='#d0d0d0')
